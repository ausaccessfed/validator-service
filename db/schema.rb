...
ActiveRecord::Schema.define(version: 20161117012959) do
  ...
  create_table "subjects", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin" do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.string   "federated_id", null: false
    t.index ["federated_id"], name: "index_subjects_on_federated_id", unique: true, using: :btree
  end
